...
// ringtone db version
const int32_t RINGTONE_RDB_VERSION = 13;

enum {
    VERSION_ADD_DISPLAY_LANGUAGE_COLUMN = 2,
    VERSION_UPDATE_MIME_TYPE = 3,
    VERSION_ADD_PRELOAD_CONF_TABLE = 4,
    VERSION_ADD_VIBRATE_TABLE = 5,
    ...
    VERSION_ADD_SOUND_MODE_VIBRATE = 11,
    VERSION_ADD_ESIM_SUPPORT = 12,
    VERSION_UPDATE_PRELOAD_CONF_TABLE = 13,
};
