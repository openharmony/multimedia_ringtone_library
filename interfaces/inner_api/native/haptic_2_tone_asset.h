...
#ifndef HAPTIC_2_TONE_ASSET_H
#define HAPTIC_2_TONE_ASSET_H
...
public:
    EXPORT Haptic2ToneAsset();
    EXPORT virtual ~Haptic2ToneAsset() = default;
    ...
    EXPORT int32_t GetHaptic2ToneType() const;
    EXPORT void SetHaptic2ToneType(int32_t type);
    ...
    EXPORT void SetScannerFlag(int32_t scannerFlag);
